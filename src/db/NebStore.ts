...
export class NebStore {
    ...
    private static INTEGRATIONS = {
        ...
        // "circleci": {
        //     name: "Circle CI",
        //     avatarUrl: "/_dimension/img/avatars/circleci.png",
        //     description: "Announces build results from Circle CI to the room.",
        //     simple: false,
        // },
        "echo": {
            name: "Echo",
            avatarUrl: "/_dimension/img/avatars/echo.png", // TODO: Make this image
            description: "Repeats text given to it from !echo",
            simple: true,
        },
        "giphy": {
            name: "Giphy",
            avatarUrl: "/_dimension/img/avatars/giphy.png",
            description: "Posts a GIF from Giphy using !giphy <query>",
            simple: true,
        },
        "guggy": {
            name: "Guggy",
            avatarUrl: "/_dimension/img/avatars/guggy.png",
